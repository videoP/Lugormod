...
typedef enum {
	...
	PM_SPINTERMISSION,	// no movement or status bar
        PM_GRAPPLING            // using a grappling hook
} pmtype_t;
...
extern int bgForcePowerCost[NUM_FORCE_POWERS][NUM_FORCE_POWER_LEVELS + 2];
#include "../namespace_end.h"
...
//Lugormod these flags should probably be elsewhere
//#define SNF_IONLYDUEL       0x0000001     //ionlyduel is active. Not used, is now persistant.
#define SNF_MELEEINPROGRESS 0x0000002     //instead of duelInProgress for melee
//RoboPhred
#define SNF_FREEZE 0x0000004
...
//        PERS_KING_SCORE //Lugormod score as King
} persEnum_t;
...
//NOTE: we only allow 10 of these! Lugormod nope 9
...
//Lugormod don't know where to put it
typedef struct 
{
        char *name;
        int   animStart;
...
static emote_t emotes[] = { 
        { "think", BOTH_FORCEHEAL_START,BOTH_FORCEHEAL_STOP,SETANIM_BOTH},
        { "kneel", BOTH_CROUCH3, BOTH_UNCROUCH3, SETANIM_BOTH },
        { "standatease", BOTH_STAND4, BOTH_STAND4TO2, SETANIM_BOTH },
        { "surrender", TORSO_SURRENDER_START, TORSO_SURRENDER_STOP, SETANIM_TORSO },
        { "layback", BOTH_SIT6, BOTH_SIT2, SETANIM_BOTH },
        { "hurt", BOTH_ROSH_PAIN, BOTH_ROSH_HEAL, SETANIM_BOTH },
        //{ "sleep", BOTH_SLEEP1, BOTH_SLEEP1GETUP2, SETANIM_BOTH },
        { "handsignal1", TORSO_HANDSIGNAL1, -1, SETANIM_BOTH },
        { "handsignal2", TORSO_HANDSIGNAL2, -1, SETANIM_BOTH },
        { "handsignal3", TORSO_HANDSIGNAL3, -1, SETANIM_BOTH },
        { "handsignal4", TORSO_HANDSIGNAL4, -1, SETANIM_BOTH },
        { "tossleft", BOTH_TOSS1, -1, SETANIM_BOTH },
        { "tossright", BOTH_TOSS2, -1, SETANIM_BOTH },
        { "talk1" ,BOTH_STAND1_TALK1, -1, SETANIM_BOTH },
        { "talk2" ,BOTH_STAND1_TALK2, -1, SETANIM_BOTH },
        { "talk3" ,BOTH_STAND1_TALK3, -1, SETANIM_BOTH },
        //{ "handsignal5", TORSO_HANDSIGNAL5, -1, SETANIM_BOTH },
        { "yes", BOTH_HEADNOD, -1, SETANIM_BOTH },
        { "no", BOTH_HEADSHAKE, -1, SETANIM_BOTH },
        { "levitate", BOTH_FORCE_ABSORB, -1 ,SETANIM_BOTH },
        { "receive", BOTH_FORCE_PROTECT_FAST, -1 , SETANIM_BOTH },
        { "comeon", BOTH_COME_ON1, -1, SETANIM_BOTH },
        { "alorataunt", BOTH_ALORA_TAUNT, -1, SETANIM_BOTH },
        { "cower", BOTH_COWER1, -1/*BOTH_COWER1_STOP*/, SETANIM_BOTH },
        { "nolisten", BOTH_SONICPAIN_HOLD, -1, SETANIM_BOTH },
        //{ "swordpower", BOTH_TAVION_SWORDPOWER, -1, SETANIM_BOTH },
